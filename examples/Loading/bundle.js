...
var baseIsEqual = __webpack_require__(121),
...
var baseAssignValue = __webpack_require__(156),
    baseForOwn = __webpack_require__(158),
...
var _exampleCode = __webpack_require__(282);
...
var YEAR_MS = 60 * 60 * 24 * 365 * 1000;

var isWeekDay = function isWeekDay(_ref) {
  var day = _ref.day;
...
var toDataSeries = function toDataSeries(_ref2) {
  var day = _ref2.day,
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.state = {
      ...
      npmPackages: (0, _keys2.default)(frameworks),
      downloads: (0, _keys2.default)(frameworks).reduce(function (res, name) {
        res[name] = [];return res;
      }, {}),
      loaded: false
    };
  ...
  (0, _createClass3.default)(App, [{
    ...
    value: function render() {
      var _state = this.state,
          npmPackages = _state.npmPackages,
          now = _state.now,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactJsxHighcharts.Tooltip, { shared: true }),
          _react2.default.createElement(
            _reactJsxHighcharts.XAxis,
            { type: 'datetime', min: now - YEAR_MS, max: now },
            _react2.default.createElement(
...
var isObject = __webpack_require__(7);
var aFunction = __webpack_require__(45);
var anInstance = __webpack_require__(309);
