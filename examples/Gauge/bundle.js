...
var _exampleCode = __webpack_require__(283);
...
var App = function (_Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = App.__proto__ || (0, _getPrototypeOf2.default)(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      kmph: 80
    }, _this.updateSpeed = function () {
      _this.setState(function (_ref2) {
        var kmph = _ref2.kmph;

        var offset = _this.getRandomSpeedOffset();
        var newKmph = Math.max(0, Math.min(200, kmph + offset));
        return {
          kmph: newKmph
        };
      });
    }, _this.getRandomSpeedOffset = function () {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { gauge: true, plotOptions: plotOptions },
          _react2.default.createElement(_reactJsxHighcharts.Pane, {
            center: ['50%', '85%'],
            size: '100%',
            startAngle: -90,
            endAngle: 90,
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_reactJsxHighcharts.SolidGaugeSeries, {
              name: 'Speed',
