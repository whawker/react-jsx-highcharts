...
const externals = {
  ...
  'highcharts':           'https://code.highcharts.com/7.2.1/highcharts.js',
  'highcharts/highstock': 'https://code.highcharts.com/stock/7.2.1/highstock.js',
  'highcharts/highmaps':  'https://code.highcharts.com/maps/7.2.1/highmaps.js',
  'highcharts-more':      'https://code.highcharts.com/7.2.1/highcharts-more.js',
  'highcharts-funnel':    'https://code.highcharts.com/7.2.1/modules/funnel.js',
  'highcharts-treemap':   'https://code.highcharts.com/7.2.1/modules/treemap.js',
  'highcharts-heatmap':   'https://code.highcharts.com/7.2.1/modules/heatmap.js',
  'highcharts-3d':        'https://code.highcharts.com/7.2.1/highcharts-3d.js',
  'highcharts-annotations':  'https://code.highcharts.com/7.2.1/modules/annotations.js',
  'highcharts-boost':     'https://code.highcharts.com/7.2.1/modules/boost.js',
  'highcharts-sankey':    'https://code.highcharts.com/7.2.1/modules/sankey.js',
  'highcharts-dependency-wheel': 'https://code.highcharts.com/7.2.1/modules/dependency-wheel.js',
  'highcharts-streamgraph': 'https://code.highcharts.com/7.2.1/modules/streamgraph.js',
  'highcharts-series-label': 'https://code.highcharts.com/7.2.1/modules/series-label.js',
  'highcharts-solid-gauge': 'https://code.highcharts.com/7.2.1/modules/solid-gauge.js',
