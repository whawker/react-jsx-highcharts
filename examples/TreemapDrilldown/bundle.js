...
var formatData = function formatData(data) {
  var colours = _highcharts2.default.getOptions().colors;
  var formattedData = [];
  (0, _keys2.default)(data).forEach(function (regionName, rIndex) {
    var region = {
      id: 'id_' + rIndex,
      name: regionName,
    ...
    var countries = (0, _keys2.default)(data[regionName]);
    countries.forEach(function (countryName, cIndex) {
      var country = {
      ...
      (0, _keys2.default)(data[regionName][countryName]).forEach(function (causeName, index) {
        var cause = {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            'Global Mortality Rate 2012, per 100,000 population'
          ),
          _react2.default.createElement(
            _reactJsxHighcharts.Subtitle,
            null,
            'Click points to drill down. Source: WHO.'
          ),
          ...
          _react2.default.createElement(_reactJsxHighcharts.Tooltip, { formatter: tooltipFormatter })
        ),
        _react2.default.createElement(
