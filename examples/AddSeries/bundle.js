...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.renderNavSeries = _this.renderNavSeries.bind(_this);
  ...
  (0, _createClass3.default)(App, [{
    ...
    value: function renderSeries(_ref) {
      ...
      return _react2.default.createElement(_.LineSeries, { id: name, name: name, key: name, data: data });
    }
  }, {
    key: 'renderNavSeries',
    value: function renderNavSeries(_ref2) {
      var name = _ref2.name;

      return _react2.default.createElement(Navigator.Series, { seriesId: name, key: name });
    }
  }, {
    key: 'render',
