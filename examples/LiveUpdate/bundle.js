...
var _exampleCode = __webpack_require__(127);
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    var now = Date.now();
    _this.state = {
      data1: (0, _dataHelpers.createRandomData)(now),
      data2: (0, _dataHelpers.createRandomData)(now),
      liveUpdate: false
    };
    return _this;
  }
  ...
  (0, _createClass3.default)(App, [{
    ...
    value: function updateLiveData() {
      ...
      this.setState({
        data1: (0, _dataHelpers.addDataPoint)(data1),
        data2: (0, _dataHelpers.addDataPoint)(data2)
      });
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_.LineSeries, { id: 'p1', name: 'Sensor 1', data: data1 }),
            _react2.default.createElement(_.LineSeries, { id: 'p2', name: 'Sensor 2', data: data2 })
          )
        ),
        _react2.default.createElement(
          'div',
