...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.handleToggleShadow = function (e) {
      e.preventDefault();
      _this.setState({
        shadow: !_this.state.shadow
      });
    };
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { className: 'btn btn-primary', onClick: this.handleToggleBackground },
            'Toggle background color'
          ),
          _react2.default.createElement(
            'button',
            { className: 'btn btn-primary', onClick: this.handleToggleShadow },
            'Toggle shadow'
          )
        )
      );
