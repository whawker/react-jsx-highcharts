...
describe('<Axis />', function ()  {
  ...
  describe('when mounted', function () {
    it('adds an X axis using the addAxis method', function () {
      mount(<Axis id="myAxis" dimension="x" addAxis={this.addAxis} />);
    ...
    it('adds a Y axis using the addAxis method', function () {
      mount(<Axis id="myAxis" dimension="y" addAxis={this.addAxis} />);
      expect(this.addAxis).to.have.been.calledWith(
    ...
    it('adds should pass additional props through to Highcharts addAxis method', function () {
      mount(<Axis id="myAxis" dimension="x" min={10} max={100} reversed addAxis={this.addAxis} />);
      expect(this.addAxis).to.have.been.calledWith(
  ...
  describe('update', function () {
    it('should update the axis if the component props change', function () {
      const wrapper = mount(<Axis id="myAxis" dimension="x" addAxis={this.addAxis} update={this.update} />);
  ...
  describe('when unmounted', function () {
    it('removes the axis', function () {
      const wrapper = mount(<Axis id="myAxis" dimension="x" addAxis={this.addAxis} remove={this.remove} />);
      wrapper.unmount();
  ...
  describe('children', function () {
    it('should pass the ID of the axis to the children', function () {
      ...
      const child = mount(<Axis id="myAxis" dimension="x" addAxis={this.addAxis}><ChildComponent /></Axis>).children();
