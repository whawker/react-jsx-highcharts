...
describe('<Navigator />', function ()  {
  ...
  describe('when mounted', function () {
    it('creates a new Highcharts Navigator instance', function () {
      mount(<Navigator update={this.update} />, {context: this.context});
    ...
    it('updates the chart with the passed props', function () {
      mount(<Navigator height={100} maskFill="rgba(1,2,3,0.45)" update={this.update} />, {context: this.context});
  ...
  describe('update', function () {
    it('should use the update method when props change', function () {
      const wrapper = mount(<Navigator update={this.update} />, {context: this.context});
