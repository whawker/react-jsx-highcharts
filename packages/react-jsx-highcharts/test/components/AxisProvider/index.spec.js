...
describe('<AxisProvider />', () => {
  ...
  it('should provide axis functions when calling getAxis', () => {
    ...
    expect(axis.addPlotBandOrLine).toEqual(expect.any(Function))
    expect(axis.removePlotBandOrLine).toEqual(expect.any(Function))
  ...
  it('should provide expected axis functions when calling getAxis', () => {
    ...
    testContext.axis.addPlotBandOrLine.mockReturnValueOnce('addPlotBandOrLine method mock');
    testContext.axis.removePlotBandOrLine.mockReturnValueOnce('removePlotBandOrLine method mock');
    ...
    expect(axis.addPlotBandOrLine({ prop: 'Test4567' })).toBe('addPlotBandOrLine method mock');
    expect(axis.removePlotBandOrLine({ prop: 'Test7654' })).toBe('removePlotBandOrLine method mock');
  ...
  it('should provide axis functions bound to the axis when calling getAxis', () => {
    ...
    testContext.axis.addPlotBandOrLine.mockReturnThis();
    testContext.axis.removePlotBandOrLine.mockReturnThis();
    ...
    expect(axis.addPlotBandOrLine({ prop: 'Test4567' })).toEqual(testContext.axis);
    expect(axis.removePlotBandOrLine({ prop: 'Test7654' })).toEqual(testContext.axis);
  ...
  it('should provide axis functions which will be cleaned prior to being called', () => {
    ...
    const cleanedFunctions = ['update', 'addPlotBandOrLine', 'setTitle'];
